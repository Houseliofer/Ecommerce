                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="/product-detail/{{ $item->category_id }}/{{ $item->id }}">{{ $item->name }}</a>
                                        <div class="ratting">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <div class="product-action">
                                            ...
                                            <a href="/product-detail/{{ $item->category_id }}/{{ $item->id }}"><i class="fa fa-search"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <div class="product-action">
                                            <a href="#"><i class="fa fa-cart-plus"></i></a>
                                            <a href="#"><i class="fa fa-heart"></i></a>
                                            <a href="/product-detail/{{ $item->category_id }}/{{ $item->id }}"><i
